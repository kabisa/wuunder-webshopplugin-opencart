...
class ControllerExtensionShippingFlat6 extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['flat6_wuunder_filter'])) {
            $data['flat6_wuunder_filter'] = $this->request->post['flat6_wuunder_filter'];
        } else {
            $data['flat6_wuunder_filter'] = $this->config->get('flat6_wuunder_filter');
        }
