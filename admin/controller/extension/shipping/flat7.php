...
class ControllerExtensionShippingFlat7 extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/shipping/flat7', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/shipping/flat7', 'token=' . $this->session->data['token'], true);
        ...
        if (isset($this->request->post['flat7_title'])) {
            $data['flat7_title'] = $this->request->post['flat7_title'];
        } else {
            $data['flat7_title'] = $this->config->get('flat7_title');
        }
        ...
        if (isset($this->request->post['flat7_wuunder_filter'])) {
            $data['flat7_wuunder_filter'] = $this->request->post['flat7_wuunder_filter'];
        } else {
            $data['flat7_wuunder_filter'] = $this->config->get('flat7_wuunder_filter');
        }
